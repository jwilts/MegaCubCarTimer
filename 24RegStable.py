...
##	Version: 5
##  Date: Jan 5/2024
##  Use RMSettings.py instead of .ini file
##  Add routine to remap RFID to be compatible with PICO RFID
##  Switch back to MSQL as MariaDB is a nightmare to install
##  
############################################################################################################
##	Version: 4
##  Date: Feb 3/2023
